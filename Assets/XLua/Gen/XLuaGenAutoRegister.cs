...
namespace XLua.CSObjectWrap
{
    public class XLua_Gen_Initer_Register__
	{
        ...
        static void wrapInit0(LuaEnv luaenv, ObjectTranslator translator)
        {
            ...
            translator.DelayWrapLoader(typeof(MTRuntime.RuntimeData), MTRuntimeRuntimeDataWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(MTRuntime.ExpectData), MTRuntimeExpectDataWrap.__Register);
